...
I utilised 'curl' in Bash scripts to deliver several sorts of HTTP headers for this networking experiment. Throughout the process, I learnt about URLs, domain names, the various HTTP request/response header fields and status codes, and so on.

how to make use of cookies.

Task six was a Python-based algorithm challenge independent from the broader project subject.
